                ...
                <Body className="bg-black text-white my-auto mx-auto font-sans">
                    <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]">
                        <Section className="mt-[32px]">
                            <Img
                                src={"https://cdn.discordapp.com/attachments/1079039236302446705/1163953174089048184/logo.png?ex=654172dd&is=652efddd&hm=002f781e11eadba44309bf011d463ef4810326d8206e1ec8388bbe41f03c505d&"}
                                width="100"
                                height="100"
                                alt="AnimeTrix"
