      ...
      <div className="flex md:flex-row flex-col gap-4 items-center flex-wrap">
        ...
        <div className="flex flex-col gap-5 items-center md:items-start">
          ...
          <div className="flex gap-5 flex-wrap justify-center lg:text-xl">
            {
              [1, 2].map((index) => (
                <button key={index} className='bg-white/40 animate-pulse duration-200 p-4 gap-3 rounded-lg text-black font-semibold flex items-center  hover:scale-95 w-32 h-12'>
                </button>
              ))
            }
          </div>

          <div className=' w-72 md:w-96 bg-white/40 border-2 border-white/30  
