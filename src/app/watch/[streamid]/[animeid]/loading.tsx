            ...
            <div className=" w-full">
                <div className=" flex justify-between lg:flex-row flex-col gap-5">
                    <div className="flex flex-col w-full 2xl:w-[70vw]">
                        <div className="w-full duration-200 animate-pulse dark:bg-white/25 bg-black/25 rounded-lg h-[30vh] lg:h-[50vh] md:h-[30vh]"></div>
                        <div className="mt-2">
                        ...
                        <div className="flex gap-3 mt-6 flex-wrap items-center">
                            <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank" className=" dark:bg-white bg-black p-2 rounded-lg font-semibold dark:text-black text-white flex items-center gap-3" rel="noopener noreferrer">
                                <Download />
                                Download
                            </a>
