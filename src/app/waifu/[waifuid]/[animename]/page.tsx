            ...
            {prevChatLoading ? (
                ...
                <section className="min-h-[92vh] lg:p-8 p-2 mb-32 w-full relative text-white overflow-y-scroll flex flex-col justify-between align-middle">
                    ...
                    <div className="flex w-full flex-col m-auto gap-3 justify-center items-center">
                        <form onSubmit={handleSubmit} className="border-2 fixed z-20 lg:w-[60%] w-[95%] md:w-[80%] md:bottom-10 bottom-[7.5rem] m-auto left-0 right-0 md:left-20 lg:left-48 border-white/10 flex gap-7 flex-wrap justify-between bg-black/80 max-h-20 rounded-lg p-6 overflow-auto">
