...
const CarouselPrevious = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (
        <Button ref={ref} variant={variant} size={size} className={cn("absolute h-8 w-8", "right-14 top-0 -translate-y-[140%]", className)} disabled={!canScrollPrev} onClick={scrollPrev} {...props}>
...
const CarouselNext = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (
        <Button ref={ref} variant={variant} size={size} className={cn("absolute h-8 w-8", "right-2 top-0 -translate-y-[140%]", className)} disabled={!canScrollNext} onClick={scrollNext} {...props}>
