        ...
        <section className=" sticky bottom-0 top-0">
            ...
            <div className=" flex gap-4 overflow-x-auto hiddenscroll duration-200 mt-9">
                {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((relation) => (
                    <div className="flex items-center p-2 hover:cursor-pointer border-2 hover:scale-95 dark:border-white/40 border-black/40 duration-200 rounded-lg" key={relation}>
