        ...
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 max-h-96 overflow-y-scroll hiddenscroll gap-5 2xl:grid-cols-4">
                {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((index: number) => (
                    <div key={index} className="dark:bg-white/40 bg-black/40 animate-pulse duration-200 dark:border-white/40 border-black/40 border-2 rounded-lg items-center p-4 flex justify-between">
