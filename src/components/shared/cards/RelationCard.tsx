                ...
                <section className=" sticky bottom-0 top-0">
                    ...
                    <div className=" flex gap-4 hiddenscroll overflow-x-auto duration-200 mt-9">
                        {details?.relations?.map((relation: Anime) => (
                            <div className="bg-white/10 flex items-center p-2 hover:cursor-pointer border-2 hover:scale-95 dark:border-white/40 border-black/40 duration-200 rounded-lg" key={relation.id}>
