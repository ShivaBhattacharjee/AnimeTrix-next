...
const SideBar = () => {
    ...
    return (
        <>
            ...
            <div
                ref={sidebarRef}
                className={`text-white fixed bottom-0 md:hidden z-20 bg-white/60 dark:bg-black/50 rounded-t-xl border-t-2 dark:border-white/25 border-black/25 backdrop-blur-md w-full p-2 duration-200 transition-all`}
            >
                <div className="flex items-center justify-between flex-wrap ">
                    ...
                    <div
                        className="flex flex-col cursor-pointer relative items-center gap-3 text-sm w-24 p-2 rounded-lg duration-200 transition-all dark:text-white text-black"
